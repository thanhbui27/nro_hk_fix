...
public class BossData {
    ...
    public static final BossData XEN_BO_HUNG = new BossData(
            ...
            new int[][]{ //skill
                {Skill.BIEN_HINH, 5, 100}, {Skill.DRAGON, 2, 200}, {Skill.DRAGON, 3, 300}, {Skill.DRAGON, 7, 700},
                {Skill.KAMEJOKO, 1, 1000}, {Skill.KAMEJOKO, 2, 1200}, {Skill.KAMEJOKO, 5, 1500}, {Skill.KAMEJOKO, 7, 1700},
                {Skill.GALICK, 1, 100},
                {Skill.THAI_DUONG_HA_SAN, 5, 45000},
                {Skill.TU_SAT, 7, 100},
                {Skill.BIEN_HINH, 5, 100}
            },
            _1_PHUT, true
    );
...
//    
    ...
    public static final BossData BAT_GIOI = BossData.builder()
        ...
        {Skill.GALICK, 1, 100}
            ...
            .secondsRest(_5_PHUT)
            .build();
     public static final BossData MAT_TROI = BossData.builder()
            .name("Mặt Trời")
            .gender(ConstPlayer.XAYDA)
            .typeDame(Boss.DAME_NORMAL)
            .typeHp(Boss.HP_NORMAL)
            .dame(50000)
            .hp(new int[][]{{5000000}})
            .outfit(new short[]{1464, 1465, 1466})
            .mapJoin(new short[]{14, 5, 7, 0})
            .skillTemp(new int[][]{
        {Skill.DRAGON, 1, 100}, {Skill.DRAGON, 2, 200}, {Skill.DRAGON, 3, 300}, {Skill.DRAGON, 7, 700},
        {Skill.KAMEJOKO, 1, 1000}, {Skill.KAMEJOKO, 2, 1200}, {Skill.KAMEJOKO, 5, 1500}, {Skill.KAMEJOKO, 7, 1700},
        {Skill.GALICK, 1, 100}
            ...
            .secondsRest(_5_PHUT)
            .build();
     public static final BossData Frieren = BossData.builder()
            .name("Frieren")
            .gender(ConstPlayer.XAYDA)
            .typeDame(Boss.DAME_NORMAL)
            .typeHp(Boss.HP_NORMAL)
            .dame(50000)
            .hp(new int[][]{{5000000}})
            .outfit(new short[]{1458, 1459, 1460})
            .mapJoin(new short[]{14, 5, 7, 0})
            .skillTemp(new int[][]{
        {Skill.DRAGON, 1, 100}, {Skill.DRAGON, 2, 200}, {Skill.DRAGON, 3, 300}, {Skill.DRAGON, 7, 700},
        {Skill.KAMEJOKO, 1, 1000}, {Skill.KAMEJOKO, 2, 1200}, {Skill.KAMEJOKO, 5, 1500}, {Skill.KAMEJOKO, 7, 1700},
