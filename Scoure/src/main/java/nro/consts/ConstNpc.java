...
public class ConstNpc {
    ...
    //npcid
    public static final byte SU_KIEN_HE = 79;
    public static final byte HOC_SKILL = 80;
    ...
    public static final int MENU_SU_KIEN = 56212;
    ...
    public static final int SHOP_SU_KIEN_HE = 5928;
    public static final int SHOP_SKILL_10 = 5929;
